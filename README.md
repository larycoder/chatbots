...
For the process to run it, you may want to read again my [previous version](https://github.com/larycoder/chatbots/blob/master/README.md) but dont need to modify any find, just need to push data for decoder as mention an token of chatBot on right file then run.
